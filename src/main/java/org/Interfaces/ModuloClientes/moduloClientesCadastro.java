...
import org.classes.util.HibernateUtilCadastroClientes;
...
import org.exceptionsInterfaces.*;
public class moduloClientesCadastro extends JFrame {
	...
	public static void moduloCliente() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					moduloClientesCadastro frame = new moduloClientesCadastro();
	...
	public moduloClientesCadastro () {
		...
		inputDescricaoCliente.setText("");
			...
			throw new exceptionsInterfaces("Erro ao se cadastrar");
		}
